...
public class QiguaActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qigua2);
        //变量
        int a = (int)(Math.random()*64+1);
        int b = (int)(Math.random()*6+1);
        //控件
        im = findViewById(R.id.img_gua2);
        gua = findViewById(R.id.zhi_2);
        jie = findViewById(R.id.jie_2);
        ...
        bian.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(QiguaActivity2.this,"随机变爻为第"+b+"爻",Toast.LENGTH_LONG).show();
            }
        });
